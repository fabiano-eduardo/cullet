...
describe("catalog-errors factories", () => {
    describe("happy path", () => {
        ...
        it("builds expired-token errors and invalid-credentials errors with their audited codes", () => {
            ...
            expect(expiredToken.code).toBe(
                ErrorCodes.authentication.expiredToken,
            );
            ...
            expect(invalidCredentials.publicMessage).toBe(
        ...
        it("builds authorization errors with stable reason metadata and top-level ids", () => {
            ...
            expect(policyDenied.code).toBe(
                ErrorCodes.authorization.policyDenied,
            );
        ...
        it("builds not-found, validation, and unexpected errors with their stable codes", () => {
            ...
            expect(unexpected.publicMessage).toBe(
