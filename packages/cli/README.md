...
- [`erp-core`](../erp-core/README.md) — núcleo de ERP com clean architecture, temporalidade, policies e rule sets.
- [`dummy-api`](../dummy-api/README.md) — kit dummy de validação do fluxo de criação (sandbox do catálogo).
