...
describe("InvalidStateTransitionException", () => {
  describe("constructor", () => {
    it("stores from, to, and message", () => {
      ...
      expect(exception.message).toBe("Cannot return to DRAFT from ACTIVE");
    });
    ...
    it("accepts empty strings", () => {
      const exception = new InvalidStateTransitionException("", "", "msg");
  ...
  describe("inheritance", () => {
    it("is an instance of DomainException", () => {
      const exception = new InvalidStateTransitionException("A", "B", "msg");
