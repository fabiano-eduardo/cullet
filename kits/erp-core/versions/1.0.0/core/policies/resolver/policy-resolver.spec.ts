...
describe("PolicyResolver", () => {
  ...
  describe("happy path", () => {
    it("prefers the most specific scope before any other tiebreaker", () => {
      ...
      const result = resolver.resolveBest([globalDefinition, schoolDefinition]);
    ...
    it("prefers higher priority when scope is tied", () => {
      ...
      const result = resolver.resolveBest([lowerPriority, higherPriority]);
    ...
    it("prefers the newest publishedAt when scope and priority are tied", () => {
      ...
      const result = resolver.resolveBest([olderDefinition, newerDefinition]);
