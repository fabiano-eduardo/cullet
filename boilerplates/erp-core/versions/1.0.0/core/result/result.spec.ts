...
describe('Result', () => {
	describe('happy path', () => {
		it('should create an Ok result through the factory and expose matching type guards', () => {
			...
			expect(
				result.match({ ok: (value) => value, err: () => 'error' })
			).toBe('value');
		});

		it('should create an Err result through the factory and expose matching type guards', () => {
			...
			expect(
				result.match({ ok: () => 'value', err: (error) => error })
			).toBe('failure');
		});

		it('should return value and null helpers for an Ok result', () => {
		...
		it('should return error helper for an Err result', () => {
		...
		it('should chain another result when flatMap receives an Ok result', () => {
		...
		it('should allow flatMap to switch from Ok to Err', () => {
			const result = Result.ok('token').mapError(() => 'unused');
			const mapped = result.flatMap((value) =>
				Result.err(`${value}_expired`)
			);
	...
	describe('error cases', () => {
		it('should throw the original Error when getOrThrow is called on an Err result with Error', () => {
		...
		it('should wrap non-Error payloads into Error when getOrThrow is called on an Err result', () => {
	...
	describe('edge cases', () => {
		it('should preserve undefined values inside an Ok result', () => {
		...
		it('should preserve falsy mapped values', () => {
		...
		it('should not call map transform when the result is Err', () => {
		...
		it('should not call mapError transform when the result is Ok', () => {
		...
		it('should not call flatMap transform when the result is Err', () => {
		...
		it('should freeze Ok and Err instances', () => {
